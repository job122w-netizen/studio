...
export default function PerfilPage() {
  ...
  const stats = [
    { icon: BookOpen, label: "Horas de Estudio", value: "128" },
    { icon: Dumbbell, label: "Ejercicios", value: "42" },
    { icon: Trophy, label: "Rango Actual", value: "#4" },
    { icon: Star, label: "Puntos HV", value: "10,900" },
  ];
    ...
    <div className="space-y-8 animate-fade-in">
      <Card className="overflow-hidden">
        <CardContent className="p-6 flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl font-bold font-headline">Usuario Imparable</h1>
