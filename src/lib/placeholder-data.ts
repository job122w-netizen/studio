...
export const hvPassLevels: HvPassLevel[] = [
  ...
  { level: 60, freeReward: { type: 'chest', quantity: 1 }, premiumReward: { type: 'profileBackground', itemId: 'pixel-art-5' } },
  ...
  { level: 70, freeReward: { type: 'chest', quantity: 1 }, premiumReward: { type: 'profileBackground', itemId: 'pixel-art-6' } },
  ...
  { level: 80, freeReward: { type: 'chest', quantity: 1 }, premiumReward: { type: 'profileBackground', itemId: 'pixel-art-7' } },
  ...
  { level: 90, freeReward: { type: 'chest', quantity: 1 }, premiumReward: { type: 'profileBackground', itemId: 'pixel-art-8' } },
  ...
  { level: 95, freeReward: { type: 'casinoChips', quantity: 5 }, premiumReward: { type: 'profileBackground', itemId: 'pixel-art-9' } },
  ...
  { level: 100, freeReward: { type: 'chest', quantity: 1 }, premiumReward: { type: 'profileBackground', itemId: 'pixel-art-10' } }
];
