...
export const tiendaItems: TiendaItem[] = [
  ...
  },
  {
    ...
    name: 'Cofre Épico',
    price: 5,
    description: 'Se abre al instante. Contiene lingotes, fichas y una pequeña probabilidad de ganar cosméticos o el Pase Premium.',
    currency: 'gems',
    consumable: true,
  },
  {
    ...
    price: 7,
    description: 'Se abre al instante. Contiene grandes recompensas y una mayor probabilidad de ganar cosméticos o el Pase Premium.',
    currency: 'gems',
    consumable: true,
  },
];
